# -------------------------------------------------------------------------------------- #
# | All credit to Liav Assif, code is modified from https://github.com/liavassif/BU-TD | #
# -------------------------------------------------------------------------------------- #
...
parser.add_argument(
    ...
    type=str,
    help=
    'root dir for dataset generation'
)
...
def load_raw_data(emnist_preprocess):
    ...
    labels = ys
    total_bins = 8
    IMAGE_SIZE = [LETTER_SIZE * 1, LETTER_SIZE * total_bins]
